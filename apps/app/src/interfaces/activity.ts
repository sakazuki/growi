...
const ACTION_USER_LOGIN_WITH_COGNITO = 'USER_LOGIN_WITH_COGNITO';
...
const ACTION_ADMIN_AUTH_COGNITO_ENABLED = 'ADMIN_AUTH_COGNITO_ENABLED';
const ACTION_ADMIN_AUTH_COGNITO_DISABLED = 'ADMIN_AUTH_COGNITO_DISABLED';
const ACTION_ADMIN_AUTH_COGNITO_UPDATE = 'ADMIN_AUTH_COGNITOB_UPDATE';
...
export const SupportedAction = {
  ...
  ACTION_USER_LOGIN_WITH_COGNITO,
  ...
  ACTION_ADMIN_AUTH_COGNITO_ENABLED,
  ACTION_ADMIN_AUTH_COGNITO_DISABLED,
  ACTION_ADMIN_AUTH_COGNITO_UPDATE,
